...
| 指标 | 数量 |
|------|------|
| 爬取帖子总量（清洗后去重） | 457,706 条（8 国） |
| 帖子 + 评论（最新批次） | 184,568 条（含评论） |
| 陪审团批量判断 | 450 条（每国 50 条抽样） |
| 检出违规 | 23 / 450（仇恨言论 9，暴力 2，成人 1，违法 1） |
| 全流程终审（含法官 LLM） | 56 条（泰国 Pantip 试点） |

### 爬虫覆盖状态（v4 大规模爬取）

| 国家 | 论坛/来源 | 语种 | 清洗后数据量 |
|------|----------|------|------------|
| 巴西 | Reddit r/brasil | 葡萄牙语 | 110,358 |
| 土耳其 | Uludağ Sözlük | 土耳其语 | 79,447 |
| 墨西哥 | Reddit r/mexico | 西班牙语 | 63,465 |
| 沙特阿拉伯 | Reddit r/saudiarabia | 阿拉伯语 | 54,103 |
| 南非 | Reddit r/southafrica | 英语 | 43,459 |
| 新加坡 | HardwareZone | 英语 | 41,860 |
| 印度尼西亚 | Kompasiana | 印尼语 | 31,578 |
| 泰国 | Pantip | 泰语 | 27,977 |
| 跨区域 | Reddit 热门聚合 | 多语种 | 5,459 |
| — | Kaskus (ID) | — | 429 限流 |
